...
public interface CastleManorProductionRepository extends CrudRepository<CastleManorProduction, Integer> {
    ...
    Iterable<CastleManorProduction> findAllByCastle(@Param("castle") int castleId);
}
