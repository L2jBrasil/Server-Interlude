 ...
 *       &lt;sequence&gt;
 *         &lt;element name="skill" type="{http://la2j.org}xmlTypeSkill" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class SkillList {
    ...
    protected List<XmlTypeSkill> skill;
     ...
     * 
     */
    public List<XmlTypeSkill> getSkill() {
        if (skill == null) {
            skill = new ArrayList<XmlTypeSkill>();
        }
        return this.skill;
    }
