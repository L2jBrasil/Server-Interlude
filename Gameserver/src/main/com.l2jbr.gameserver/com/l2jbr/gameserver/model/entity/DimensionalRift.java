...
public class DimensionalRift {
    ...
    protected List<Byte> _completedRooms = new LinkedList<>();
    ...
    protected List<L2PcInstance> deadPlayers = new LinkedList<>();
    protected List<L2PcInstance> revivedInWaitingRoom = new LinkedList<>();
    ...
    protected void teleportToNextRoom(L2PcInstance player) {
        if (_choosenRoom == -1) { // Do not tp in the same room a second time
            do {
