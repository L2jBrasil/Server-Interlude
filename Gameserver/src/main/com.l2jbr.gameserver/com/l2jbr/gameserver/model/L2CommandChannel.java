...
import com.l2jbr.gameserver.serverpackets.ExCloseMPCC;
import com.l2jbr.gameserver.serverpackets.ExOpenMPCC;
...
public class L2CommandChannel {
    ...
    public List<L2PcInstance> getMembers() {
        List<L2PcInstance> members = new LinkedList<>();
