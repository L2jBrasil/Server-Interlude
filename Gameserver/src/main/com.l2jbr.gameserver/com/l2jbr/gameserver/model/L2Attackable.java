...
import com.l2jbr.gameserver.datatables.EventDroplist.DateDrop;
...
public class L2Attackable extends L2NpcInstance {
    ...
    /**
     * Use this to Remove Object from this Map This Should be Synchronized While Iterating over This Map - ie you can't iterating and removing object at once.
     *
     * @return
     */
            ...
            if (!rewards.isEmpty()) {
                ...
                for (Map.Entry<L2Character, RewardInfo> entry : rewards.entrySet()) {
                    ...
                    if (attackerParty == null) {
                        ...
                        List<L2PlayableInstance> rewardedMembers = new LinkedList<>();
     ...
     * <B><U> Concept</U> :</B><BR>
     * <BR>
     * During a Special Event all L2Attackable can drop extra Items. Those extra Items are defined in the table <B>allNpcDateDrops</B> of the EventDroplist. Each Special Event has a start and end date to stop to drop extra Items automatically. <BR>
     * <BR>
     * <B><U> Actions</U> : </B><BR>
     * <BR>
    ...
    public void doItemDrop(L2NpcTemplate npcTemplate, L2Character lastAttacker) {
        ...
        for (L2DropCategory cat : npcTemplate.getDropData()) {
            ...
            if (cat.isSweep()) {
                ...
                if (isSpoil()/* && !isSeeded() */) {
                    List<RewardItem> sweepList = new LinkedList<>();
     ...
     * @param crystalId an integer indicating the event when mob dies. This should be: = 0 - "the crystal scatters"; = 1 - "the crystal failed to absorb. nothing happens"; = 2 - "the crystal resonates because you got more than 1 crystal on you"; = 3 -
     *                  "the crystal cannot absorb the soul because the mob level is too low"; = 4 - "the crystal successfully absorbed the soul";
     */
    ...
    public void setSeeded(int id, int seederLvl) {
        ...
        List<RewardItem> harvested = new LinkedList<>();
