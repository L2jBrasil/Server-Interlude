...
public class AutoSpawnHandler {
    ...
    /**
     * @param spawnInst
     * @return the number of milliseconds until the next occurrence of the given spawn.
     */
    ...
    public Map<Integer, AutoSpawnInstance> getAutoSpawnInstances(int npcId) {
        Map<Integer, AutoSpawnInstance> spawnInstList = new LinkedHashMap<>();
    ...
    public class AutoSpawnInstance {
        ...
        private final List<L2NpcInstance> _npcList = new LinkedList<>();

        private final List<Location> _locList = new LinkedList<>();
        ...
        public L2Spawn[] getSpawns() {
            List<L2Spawn> npcSpawns = new LinkedList<>();
