...
import com.l2jbr.gameserver.script.EngineInterface;
import com.l2jbr.gameserver.script.Expression;
...
public class FaenorInterface implements EngineInterface {
     ...
     *
     * @see com.l2jbr.gameserver.script.EngineInterface#addQuestDrop(int, int, int, int, int, String, String[])
     */
    @Override
    ...
    public List<L2DropData> getQuestDrops(int npcID) {
        ...
        List<L2DropData> questDrops = new LinkedList<>();
        for (L2DropCategory cat : npc.getDropData()) {
    ...
    public void addPetData(BSFManager context, int petID, int levelStart, int levelEnd, Map<String, String> stats) throws BSFException {
