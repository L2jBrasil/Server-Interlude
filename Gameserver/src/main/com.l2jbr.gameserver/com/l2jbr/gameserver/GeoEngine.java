...
public class GeoEngine extends GeoData {
    ...
    private static Map<Short, MappedByteBuffer> _geodata = new LinkedHashMap<>();
    private static Map<Short, IntBuffer> _geodataIndex = new LinkedHashMap<>();
    ...
    /**
     * @see com.l2jbr.gameserver.GeoData#getType(int, int)
     */
    @Override
    ...
    /**
     * @see com.l2jbr.gameserver.GeoData#getHeight(int, int, int)
     */
    @Override
    ...
    /**
     * @see com.l2jbr.gameserver.GeoData#geoPosition(int, int)
     */
    @Override
    ...
    /**
     * @see com.l2jbr.gameserver.GeoData#canSeeTarget(com.l2jbr.gameserver.model.L2Object, com.l2jbr.gameserver.model.L2Object)
     */
    @Override
    ...
    /**
     * @see com.l2jbr.gameserver.GeoData#canSeeTargetDebug(com.l2jbr.gameserver.model.actor.instance.L2PcInstance, com.l2jbr.gameserver.model.L2Object)
     */
    @Override
    ...
    /**
     * @see com.l2jbr.gameserver.GeoData#getNSWE(int, int, int)
     */
    @Override
    ...
    /**
     * @see com.l2jbr.gameserver.GeoData#moveCheck(int, int, int, int, int, int)
     */
    @Override
    ...
    /**
     * @see com.l2jbr.gameserver.GeoData#addGeoDataBug(com.l2jbr.gameserver.model.actor.instance.L2PcInstance, String)
     */
    @Override
    ...
    private static void nInitGeodata() {
        ...
        final File geoIndex = new File("./data/geodata/geo_index.txt");
        if (!geoIndex.exists()) {
            return;
        }

        try (LineNumberReader lnr = new LineNumberReader(new BufferedReader(new FileReader(geoIndex)))) {
            String line;
    ...
    private static boolean nLOS(int x, int y, int z, int inc_x, int inc_y, int tz, boolean debug) {
        ...
        {
            if (debug) {
                _log.warn("flatheight:" + geo.getShort(index));
            }
            return true;
        } else if (type == 1) // complex
        {
        ...
        // multilevel, type == 2
        {
            ...
            while (temp_layers > 0) {
                ...
                if (((z - tempz) * (z - tempz)) > ((z - height) * (z - height))) {
                    ...
                    tempz = height;
                    if (debug) {
                        _log.warn("z" + (z + 45) + " tempz" + tempz + " dz" + (z - tempz));
                    }
                    NSWE = geo.getShort(index);
                    NSWE = (short) (NSWE & 0x0F);
                }
