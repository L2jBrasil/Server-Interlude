...
public final class RequestMakeMacro extends L2GameClientPacket
{
	...
	protected void readImpl()
	{
		...
		int _icon = readUnsignedByte();
		int _count = readUnsignedByte();
		...
		{
			int entry = readUnsignedByte();
			int type = readUnsignedByte(); // 1 = skill, 3 = action, 4 = shortcut
			int d1 = readInt(); // skill or page number for shortcuts
			int d2 = readUnsignedByte();
