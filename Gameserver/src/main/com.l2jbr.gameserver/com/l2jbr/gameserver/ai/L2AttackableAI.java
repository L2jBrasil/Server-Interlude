			...
			if ((weapon != null) && (weapon.getItemType() == L2WeaponType.BOW))
			{
				...
				if (distance2 <= 10000)
				{
					...
					if (chance >= Rnd.get(100))
					{
						...
						setIntention(Intention.AI_INTENTION_MOVE_TO, new L2CharPosition(posX, posY, posZ, 0));
						return;
					}
				}
			}
