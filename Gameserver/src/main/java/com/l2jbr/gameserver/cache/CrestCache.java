...
public class CrestCache
{
	...
	private final FastMap<Integer, byte[]> _cachePledge = new FastMap<>();
	
	private final FastMap<Integer, byte[]> _cachePledgeLarge = new FastMap<>();
	
	private final FastMap<Integer, byte[]> _cacheAlly = new FastMap<>();
	...
	public void reload()
	{
		...
		FastMap<Integer, byte[]> _mapPledge = _cachePledge;
		FastMap<Integer, byte[]> _mapPledgeLarge = _cachePledgeLarge;
		FastMap<Integer, byte[]> _mapAlly = _cacheAlly;
