...
class PacketHistory
{
	...
	{
		/**
		 * @see javolution.xml.XMLFormat#read(javolution.xml.XMLFormat.InputElement, Object)
		 */
		@Override
		...
		/**
		 * @see javolution.xml.XMLFormat#write(Object, javolution.xml.XMLFormat.OutputElement)
		 */
		@Override
